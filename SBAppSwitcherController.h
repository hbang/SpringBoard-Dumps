...
@class NSDictionary, SBDisplayLayout, NSMutableDictionary, SBAppSwitcherServices, NSMutableSet, UIView, SBAppSwitcherStatusBarViewCache, SBAppSwitcherPageViewController, NSMutableArray, SBAppSwitcherPeopleViewController, NSObject, _UILegibilitySettings, SBAppSwitcherRemoteAlertSet, SBAppSwitcherIconController, SBAppSwitcherSettings, UIGestureRecognizer, UISwipeGestureRecognizer, SBAppSwitcherContainer, NSString;
