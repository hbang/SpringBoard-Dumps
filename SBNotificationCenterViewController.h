...
@class NSSet, SBChevronView, UIView, NSString, _UIBackdropView, SBModeViewController, SBNotificationSeparatorView, SBBulletinObserverViewController, UIGestureRecognizer, UIStatusBar;
