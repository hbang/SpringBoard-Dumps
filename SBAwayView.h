...
@class SBAwayViewPluginController, SBNowPlayingArtView, UIImage, SBAlertImageView, UIModalView, NSTimer, TPBottomLockBar, UIPushButton, SBAwayChargingView, SBAwaySwipeGestureRecognizer, NSDictionary, SBAwayDateView, NSString, SBAwayInCallController, SBAwayItemsView, SBActivationView, TPBottomButtonBar;
