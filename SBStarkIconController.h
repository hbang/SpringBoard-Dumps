...
@class NSSet, SBStarkFolderController, SBIconModel, SBStarkIconLayoutOverrideStrategy, _UILegibilitySettings, AVExternalDevice, SBStarkFakeIconOperationController, NSIndexPath, SBIcon, SBIconViewMap;
