...
@class PCPersistentTimer, UILocalNotification, SBActivationContext, BKSProcessAssertion, SBAppContextHostManager, SBDefaultImageInfo, NSArray, NSTimer, NSString, NSMapTable, NSMutableSet, NSHashTable, NSSet, NSDictionary, UIColor, BKSCFBundle, BKSMachSendRight, NSDate, UIRemoteApplication;
