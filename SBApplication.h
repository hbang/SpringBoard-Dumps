...
@class NSDictionary, BSCFBundle, BSMachSendRight, NSMutableDictionary, FBProcessState, FBApplicationProcess, NSMutableSet, UIRemoteApplication, NSTimer, PCPersistentTimer, BKSProcessAssertion, NSMutableArray, FBApplicationInfo, BKSApplicationDataStore, NSDate, CLLocationManager, SBActivationSettings, NSSet, NSHashTable, SBDeactivationSettings, NSArray, SBStateSettings, NSMapTable, NSString;
