...
@class SBIcon, SBFolderControllerAnimationContext, NSString, NSArray, NSTimer, _UILegibilitySettings, SBIconViewMap, SBIconAnimator, SBFolder, SBFolderView, NSMapTable, SBFolderContext;
