...
@class NSMapTable, SBFolder, _UILegibilitySettings, NSArray, SBFolderContext, NSTimer, SBIcon, SBIconAnimator, SBFolderControllerAnimationContext, SBFolderView, SBIconViewMap;
