...
@class NSString, SBAlertView, SBStateSettings, UIScreen, SBAlertManager, UIViewController, NSHashTable, SBActivationSettings, SBDeactivationSettings, NSMutableDictionary;
