...
@class SBAppSliderSettings, SBAppSliderScrollingViewController, NSObject, SBAppSwitcherStatusBarViewCache, SBAppSliderIconController, NSString, SBAppSliderContainer, NSArray, NSMutableDictionary, NSMutableSet, SBAppSwitcherServices, UIView, NSMutableArray, NSDictionary;
