...
@class NSDate, SBAwayModel, NSTimeZone, NSTimer, SBAwayItem, NSString, SBSlidingAlertDisplay, SBAwayView, SBAlertItem, NSMutableArray, SBUIController, NSDictionary;
