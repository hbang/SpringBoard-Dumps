...
@class SBAppSwitcherController, NSString, UIStatusBar, FBUIApplicationResignActiveAssertion, FBWorkspaceEventQueueLock, NSArray, SBDismissOnlyAlertItem, NSMutableDictionary, NSMutableSet, SBSwitchAppGestureView, UIView, SBApplication, NSMutableArray, SBAnimationStepper, SBAppSwitcherWindowController, SBWindow;
