...
@class NSObject, SBAppSwitcherStatusBarViewCache, SBSnapshotImageInfo, SBAppSliderSettings, UIImageView, SBWallpaperEffectView, SBZoomableCrossfadeView, UIView, UIImage, SBApplication;
