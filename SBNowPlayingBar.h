...
@class UIButton, MPAudioDeviceController, SBNowPlayingBarView, SBApplication, SBSwitcherSlider, SBAirPlayBarView, MPAudioVideoRoutingActionSheet, MPAudioVideoRoutingPopoverController;
