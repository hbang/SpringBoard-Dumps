...
@class BBDataProviderConnection, SBPowerDownController, NSString, SBUIController, NSHashTable, UIWindow, NSMutableSet, NSTimer, SBApplication, NSMutableArray, NSNumberFormatter, NSDate, SBCardItemsController, NSSet, NSObject;
