...
@class SBWorkspaceEventQueueLockAssertion, NSObject, SBWorkspaceTransaction, NSTimer, BKSWorkspace, SBScreenTimeTrackingController, NSMutableArray, SBAlertManager;
