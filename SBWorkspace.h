...
@class SBAlertManager, NSString, FBWorkspaceEventQueueLock, SBWorkspaceTransaction, FBSceneManager, FBScene, NSMutableDictionary, BSWatchdog, NSMutableSet, SBScreenTimeTrackingController, NSTimer, NSMutableArray, NSSet, SBWindow;
