...
@class NSTimer, SBWorkspaceTransaction, BKSWorkspace, NSMutableArray, SBScreenTimeTrackingController, SBAlertManager, SBWorkspaceEventQueueLockAssertion, NSObject;
